...
export const Carousel = React.forwardRef(({children, fluid, ...props}, ref) => {
        ...
        return (
            <section className={`${props.className}`}>
                <div className={'d-flex justify-content-between ' }>
                    ...
                    <div ref={ref} className={`d-flex justify-content-center align-items-start ${fluid ? 'container-fluid': 'container'}`} style={{height: props.maxHeight+'px'}}>
